...
const mockDrivers: Driver[] = [
  { id: 'BC12345678', name: 'Juan Pérez', company: 'Transportes Veloz' },
  { id: 'BC87654321', name: 'Ana García', company: 'Logística Rápida' },
  { id: 'BC55566677', name: 'Carlos Sánchez', company: 'Entregas Express' },
  { id: 'BC99988877', name: 'Laura Martínez', company: 'Mondial Relay' },
  { id: 'BC11223344', name: 'Pedro Rodríguez', company: 'Transportes Veloz' },
  { id: 'BC44332211', name: 'Sofía López', company: 'Mondial Relay' },
  { id: 'BC67891234', name: 'David Fernández', company: 'Logística Rápida' },
  { id: 'BC43219876', name: 'Elena Gómez', company: 'Entregas Express' },
];
