        ...
        <div className="min-h-screen flex flex-col justify-center items-center p-4">
            <div className="max-w-md w-full bg-white/95 backdrop-blur-sm rounded-xl shadow-xl p-8 space-y-6">
                <div className="text-center">
                    <h1 className="text-3xl font-bold text-gray-800">{t('plateEntry.greeting', { name: driver.name })}</h1>
                    <p className="text-gray-500 mt-2">{t('plateEntry.instruction')}</p>
                </div>
                
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="plate-input" className="block text-sm font-medium text-gray-700">
                            {t('plateEntry.plateLabel')}
                        </label>
                        <input
                            ref={inputRef}
                            id="plate-input"
                            ...
                            required
                            placeholder={t('plateEntry.platePlaceholder')}
                        />
                    </div>
                    <button 
                        type="submit" 
